...
class DeadEasyUI(object):
    ...
    def launch(self, prompt = 'Enter Command or "help" for help >> ', run_in_loop = True, forgive_unquoted_strings=True):
        """
        Launch a command-line UI.
        :param prompt:
        :param run_in_loop:
        :param forgive_unquoted_strings:
        :return:
        """
        ...
        while True:
            ...
            cmd, args, kwargs = parse_user_function_call(user_input, forgive_unquoted_strings=forgive_unquoted_strings)
...
def parse_user_function_call(cmd_str, forgive_unquoted_strings = False):
    """
